          ...
          <Grid container spacing={8} justify="flex-start">
            ...
            >
              ...
              <Grid item xs={12} sm={6}>
                ...
                <Accordion>
                  <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                      <Typography>How long does a blood donation take?</Typography>
                  </AccordionSummary>
                  <AccordionDetails>
                    <Typography>
                ...
                <Accordion>
                  <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                      <Typography>Are guests or kids allowed to come to blood drives or donation centers with a donor?</Typography>
                  </AccordionSummary>
                  <AccordionDetails>
                    <Typography>
                    During this coronavirus outbreak, the Red Cross is not allowing guests including children to enter a blood drive or center to ensure we can maintain social distancing as we adhere to new safety precautions.
                  </Typography>
                </AccordionDetails>
                </Accordion>
                ...
                <Accordion>
                  <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                      <Typography>How long will it take to replenish the pint of blood I donate?</Typography>
                  </AccordionSummary>
                  <AccordionDetails>
                    <Typography>
                ...
                <Accordion>
                  <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                      <Typography>Why does the Red Cross ask so many personal questions when I give blood?</Typography>
                  </AccordionSummary>
                  <AccordionDetails>
                    <Typography>
                ...
                <Accordion>
                  <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                      <Typography>Can donors wear a mask at a blood drive?</Typography>
                  </AccordionSummary>
                  <AccordionDetails>
                    <Typography>
                    In accordance with the updated CDC guidelines, beginning April 15, donors will be required to wear face masks at a blood drive or donation center. We encourage donors to bring their own face masks. If a donor does not have a mask, the Red Cross will provide one. If a donor does not want to wear a mask, we ask they postpone their donation for a later date
                  </Typography>
                </AccordionDetails>
                </Accordion>
