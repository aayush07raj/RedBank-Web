...
function Footer() {
  ...
  return (
    ...
    >
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={3} md={3}>
          <Typography align={"center"} className={classes.text} gutterBottom>
            ...
            <ul>
              <Button className={classes.text} startIcon={<FacebookIcon />}>
                {" "}
                Facebook{" "}
              </Button>
            </ul>
            <ul>
              <Button className={classes.text} startIcon={<LinkedInIcon />}>
                Linkedin
              </Button>
            </ul>
            <ul>
              <Button className={classes.text} startIcon={<InstagramIcon />}>
                Instagram
              </Button>
            </ul>
            <ul>
              <Button className={classes.text} startIcon={<YouTubeIcon />}>
                Youtube
              </Button>
            </ul>
          </Typography>
        ...
        <Grid item xs={12} sm={3} md={3}>
          <Typography align={"center"} gutterBottom className={classes.text}>
            ...
            <ul>
              <Button component={Link} to="/BuyBlood" className={classes.text}>
                Buy Blood
              </Button>
            </ul>
            <ul>
      ...
      <Typography className={classes.text}>© Copyright 2021</Typography>
    </div>
  );
}
